...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBLightSourceDetector",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.6-65-gbf994362d5/BNBLightSourceDetector.zip",
            checksum: "4b870e5de7ac5c3de0e11c28d523124b3a3817e07889c407dc88a60f0f608a03"
        ),
        .target(
