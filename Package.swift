...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBLightSourceDetector",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.2-5-gf3828971b9/BNBLightSourceDetector.zip",
            checksum: "8bcb1256d4cc8575930e8720260962fb5d082919f467308a307a5806dfd6ff39"
        ),
        .target(
