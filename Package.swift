...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBLightSourceDetector",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.0-33-g2b785861d0/BNBLightSourceDetector.zip",
            checksum: "52c9b23eeffa8c16f8aea0b0e526c2c77a2c621ef2835bf0cdd6b5d211b1782d"
        ),
        .target(
