...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBLightSourceDetector",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.17.1-32-gc91d258b34/BNBLightSourceDetector.zip",
            checksum: "eb4529902c97e136f9a0bacb6a00fdaea0c11e74621a9c776f55709ead1fed8f"
        ),
        .target(
